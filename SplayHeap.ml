...
insert ∷ Ord α ⇒ α ⨯ α ⨯ Tree α (* | [ 1 ↦ 1, (1 0) ↦ 6, (0 2) ↦ 1 ] *) → Tree α (* | [ 1 ↦ 1, (0 2) ↦ 1 ] *)
insert d x h = match partition d x h with
  | leaf      → (leaf, x, leaf)
  | (l, y, r) → (l, x, r)


partition ∷ Ord α ⇒ α ⨯ α ⨯ Tree α (* | [ 1 ↦ 1, (1 0) ↦ 3, (0 2) ↦ 2 ] *) → Tree α (* | [ 1 ↦ 1, (0 2) ↦ 1 ] *)
...
del_min ∷ Ord α ⇒ Tree α (* | [ 1 ↦ 1, (1 0) ↦ 1, (1 1) ↦ 1, (0 2) ↦ 1 ] *) → Tree α (* | [ 1 ↦ 1, (0 2) ↦ 1 ] *)
