...
splay ∷ Ord α ⇒ (α ⨯ Tree α) → Tree α | [[0 ↦ 5/6, (1 0) ↦ 5/6, (0 2) ↦ 1/3] → [0 ↦ 5/6, (0 2) ↦ 1/3], {[(1 0) ↦ 5/12] → [(1 0) ↦ 5/12]}]
...
splay_zigzig ∷ (α ⨯ Tree α) → Tree α | [[0 ↦ 5/6, (1 0) ↦ 5/6, (0 2) ↦ 1/3] → [0 ↦ 5/6, (0 2) ↦ 1/3], {[(1 0) ↦ 5/12] → [(1 0) ↦ 5/12]}]
