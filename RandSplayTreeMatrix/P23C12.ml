 ...
 * DO NOT EDIT
 *
 * Cost for recursion : 2/3 = 1 - 1/2
 * Cost for rotation  : 1/2 = 1 - 1/2
 * Coin probability   : 2/3
 *)

splay ∷ Ord α ⇒ (α ⨯ Tree α) → Tree α | [[0 ↦ 5/6, (1 0) ↦ 55/36, (0 2) ↦ 1/2] → [0 ↦ 5/6, (0 2) ↦ 1/2], {[(1 0) ↦ 5/12] → [(1 0) ↦ 5/12]}]
...
splay_zigzig ∷ (α ⨯ Tree α) → Tree α | [[0 ↦ 5/6, (1 0) ↦ 55/36, (0 2) ↦ 1/2] → [0 ↦ 5/6, (0 2) ↦ 1/2], {[(1 0) ↦ 5/12] → [(1 0) ↦ 5/12]}]
