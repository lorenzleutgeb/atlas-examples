...
splay ∷ Ord α ⇒ (α ⨯ Tree α) → Tree α | [[0 ↦ 2/3, (1 0) ↦ 1, (0 2) ↦ 1/3] → [0 ↦ 2/3, (0 2) ↦ 1/3], {[(1 0) ↦ 1/3] → [(1 0) ↦ 1/3]}]
...
splay_zigzig ∷ (α ⨯ Tree α) → Tree α | [[0 ↦ 2/3, (1 0) ↦ 1, (0 2) ↦ 1/3] → [0 ↦ 2/3, (0 2) ↦ 1/3], {[(1 0) ↦ 1/3] → [(1 0) ↦ 1/3]}]
